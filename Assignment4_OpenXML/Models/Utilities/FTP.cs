...
namespace Assignment4_OpenXML.Models.Utilities
{
    class FTP
    {
        public static List<string> GetDirectory(string url, string username = Constants.UserName, string password = Constants.Password)
        {
        ...
        public static string DownloadFile(string sourceFileUrl, string destinationFilePath, string username = Constants.UserName, string password = Constants.Password)
        {
            string output;
        ...
        /// <param name="password"></param>
        /// <returns></returns>
        public static bool FileExists(string remoteFileUrl, string username = Constants.UserName, string password = Constants.Password)
        {
            // Get the object used to communicate with the server.
        ...
        /// <param name="password"></param>
        /// <returns></returns>
        public static byte[] DownloadFileBytes(string sourceFileUrl, string username = Constants.UserName, string password = Constants.Password)
        {
            byte[] output;
