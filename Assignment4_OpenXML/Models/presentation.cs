...
namespace Assignment4_OpenXML.Models
{
    class presentation
    {
        ...
        public static void CreatePresentation(string filepath)
        {
            ...
            para.AppendChild(new Text("Hello"));
        ...
        private static SlideMasterPart CreateSlideMasterPart(SlideLayoutPart slideLayoutPart1)
        {
            ...
            new CommonSlideData(new ShapeTree(
              ...
              new P.Shape(
              new P.NonVisualShapeProperties(
                new P.NonVisualDrawingProperties() { Id = (UInt32Value)2U, Name = "TPresentation OpenXML1" },
                new P.NonVisualShapeDrawingProperties(new ShapeLocks() { NoGrouping = true }),
        ...
        public static void InsertNewSlide(PresentationDocument presentationDocument, int position, string slideTitle)
        {
            ...
            titleShape.NonVisualShapeProperties = new NonVisualShapeProperties
                (new NonVisualDrawingProperties() { Id = drawingObjectId, Name = "Title" }, new NonVisualShapeDrawingProperties(new Drawing.ShapeLocks() { NoGrouping = true }), new ApplicationNonVisualDrawingProperties(new PlaceholderShape() { Type = PlaceholderValues.Title }));
